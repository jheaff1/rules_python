...
toolchain(
    ...
    toolchain = ":{platform}_python_runtimes",
    toolchain_type = "@bazel_tools//tools/python:toolchain_type",
)

py_runtime_pair(
    name = "{platform}_python_runtimes",
    py2_runtime = "@{user_repository_name}_py2//:py2_runtime",
    py3_runtime = "@{user_repository_name}_{platform}//:py3_runtime",
)

## here i add the py_runtime_pairs which reference @{user_repository_name}_{platform}//:python3_runtime
""".format(
            platform = platform,
            name = rctx.attr.name,
...
alias(name = "python_runtimes", actual = "@{py_repository}_toolchains//:{host_platform}_python_runtimes")
""".format(
